...
<body>
    ...
    <script>
        ...
        const ADMIN_PASSWORD = "sorteo2024"; // Cambia la contraseña
        const PARTICIPANTS = ["Noe", "Erika", "Belén", "Miryam", "Dayana", "Ada"]; // Tu lista
        ...
        // Función de sorteo simple y funcional
        function drawPairings() {
            ...
            // Ajustar si hay auto-asignación
            ...
            try {
                ...
                addLog("Parejas guardadas correctamente");
            } catch (e) {
                addLog("Advertencia: No se pudo guardar, pero se mostrarán resultados");
            }
            return pairings;
        }
        ...
        function getPairings() {
            try {
                ...
                addLog("Error al cargar parejas guardadas");
                return null;
            }
        }

        // Eventos (todos simples y directos)
        ...
        adminLogin.addEventListener("click", () => {
            ...
            if (adminPass.value === ADMIN_PASSWORD) {
                ...
                if (pairings) {
                    ...
                    addLog("Mostrados resultados guardados");
                }
            } else {
        ...
        checkAssignment.addEventListener("click", () => {
            ...
            addLog("Asignación mostrada a: " + name);
        });
